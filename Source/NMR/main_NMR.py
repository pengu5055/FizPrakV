...
fig, ax = plt.subplots()
fittext = "Exp. fit: $y = U_0exp(-2t/T_2)$\n$U_0$ = {} ± {}\n$T_2$ = {} ± {}"\
...
fit = exp2(np.linspace(0, 20, 2000), *fitpar)
...
plt.errorbar(t1, u1, yerr=u1_err,  markersize=2, color=c2,
             linestyle='None', marker="o", capsize=2, alpha=1, label="Meritve")
plt.plot(np.linspace(0, 20, 2000), fit, c=c3)
...
fit = exp2(np.linspace(0, 5, 2000), *fitpar)
...
plt.errorbar(t1, u1, yerr=u1_err,  markersize=2, color=c2,
             linestyle='None', marker="o", capsize=2, alpha=1, label="Meritve")
plt.plot(np.linspace(0, 5, 2000), fit, c=c3)
